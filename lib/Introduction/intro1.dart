          ...
          children: [
                    ...
                    child: Text("Skip",
                        style: TextStyle(
                          decoration: TextDecoration.underline,
                            decorationColor: Color(0xffF25278),
            ...
            Container(
                ...
                child: const Column(
                  children: [
                    Text(
                        "By Signing up you agree to the Terms and Condition of 'LOVE' your way! ",
                        textAlign: TextAlign.center,
                        style: TextStyle(
  ...
  Container buildDot(int index, BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: visited ? const Color(0xffF26B8A) : const Color(0xffD1D1D6),
      ),
    );
  }
}
